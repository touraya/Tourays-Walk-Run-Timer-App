...
/* Tourays Fitness V10 — Stage 20 profile position repair */
(function(){
  "use strict";
  ...
  function activate(route){
    ...
    if(route==="profileSettingsScreen"){
      const profile=document.getElementById("profileSettingsScreen");
      if(profile){
        profile.scrollTop=0;
        const shell=profile.querySelector(".profile-settings-shell");
